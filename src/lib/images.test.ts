...
describe('photoSrcSet', () => {
  it('lists sized siblings before the full-resolution file', () => {
    expect(photoSrcSet('/assets/recantos/horizonte/hero.webp', [640, 960], 1920)).toBe(
      '/assets/recantos/horizonte/hero-640.webp 640w, /assets/recantos/horizonte/hero-960.webp 960w, /assets/recantos/horizonte/hero.webp 1920w',
    )
  })
})
